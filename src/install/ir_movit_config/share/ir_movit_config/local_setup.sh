...
: ${AMENT_CURRENT_PREFIX:="/home/michele-zarantonello/ws_32_assignments/src/install/ir_movit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ir_movit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ir_movit_config/environment/path.sh"
